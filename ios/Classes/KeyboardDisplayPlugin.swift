...
public class KeyboardDisplayPlugin: NSObject, FlutterPlugin,FlutterStreamHandler {
    public static func register(with registrar: FlutterPluginRegistrar) {
        let eventChannel = FlutterEventChannel.init(name: "keyboard_display", binaryMessenger: registrar.messenger())
        let instance = KeyboardDisplayPlugin()
